...
@Component({
  ...
  templateUrl: './classic-level-numbers.component.html',
  styleUrls: ['./classic-level-numbers.component.scss']
})
export class ClassicLevelNumbersComponent implements OnInit {
  public LevelId = 1; 
  start = true;
  verify = false;
  isVisible = false;
