...
getRandomInt(min: number, max: number) {
 ...
 public course(){
  ...
  this.dialog.open(DialogNextLevel);
...
@Component({
  selector: 'dialog-next-level',
  templateUrl: 'dialog-next-level.html',
})
export class DialogNextLevel {
  constructor(public dialog: MatDialog, public dialogRef: MatDialogRef<DialogNextLevel>) { }
